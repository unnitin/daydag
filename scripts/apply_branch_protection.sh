...
echo
echo "There is no AI reviewer. It was removed after seven CI failures - see"
echo "CONTRIBUTING.md. Review happens locally via /code-review before pushing,"
echo "and CodeQL covers dataflow analysis with no credential required."
