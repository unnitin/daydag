...
echo "  - ai review: DISABLED (see below)"
echo "  - no force-push, no deletion"
echo "  - bypass: repository admins only (actor_id 5 = admin role)"
echo
echo "The AI reviewer is off. Its check is not required and the workflow is"
...
echo "  then add the single \"ai review\" context above and re-run this script."
